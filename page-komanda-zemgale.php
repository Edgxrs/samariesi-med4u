<?php
/**
 * Template Name: Komanda Zemgale
 * Description: Shows the Zemgale team members with enhanced accessibility and styling.
 */
...
<section class="team-intro-header">
  <div class="intro-content">
    ...
    <!-- Contact information for Zemgale -->
    <div class="region-contact-info">
      <div class="contact-highlight">
        <i class="fas fa-phone" aria-hidden="true"></i>
        <span>Koordinators (sadarbībā ar SIA Cilvēks): <a href="tel:+37125762922">29123456</a></span>
      </div>
    </div>
  </div>
</section>
...
<main class="team-page" role="main">
  ...
  <section class="team-organization" role="region" aria-label="Zemgales komandas organizācija">
    <?php
...
<section class="team-services">
    ...
    <div class="services-grid">
      <div class="service-item">
        ...
        <h3>Aprūpe mājās</h3>
        <p>Nodrošinām kvalitatīvu aprūpi pacienta dzīvesvietā visā Zemgales reģionā</p>
      </div>
      <div class="service-item">
        <i class="fas fa-phone" aria-hidden="true"></i>
